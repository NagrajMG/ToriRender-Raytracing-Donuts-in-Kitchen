...
template <typename BasicJsonType,
          ...
          enable_if_t<std::is_assignable<ConstructibleArrayType&, ConstructibleArrayType>::value,
                      int> = 0>
...
auto from_json(BasicJsonType&& j, identity_tag<std::array<T, N>> tag)
  ...
  return from_json_inplace_array_impl(
      std::forward<BasicJsonType>(j), tag, make_index_sequence<N>{});
}
...
inline void from_json_tuple_impl(BasicJsonType&& j,
                                 std::pair<A1, A2>& p,
                                 priority_tag<1> /*unused*/) {
  p = from_json_tuple_impl(
      std::forward<BasicJsonType>(j), identity_tag<std::pair<A1, A2>>{}, priority_tag<0>{});
}
...
auto from_json(BasicJsonType&& j, TupleRelated&& t)
  ...
  return from_json_tuple_impl(
      std::forward<BasicJsonType>(j), std::forward<TupleRelated>(t), priority_tag<3>{});
}
