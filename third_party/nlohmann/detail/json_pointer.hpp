...
/// @brief JSON Pointer defines a string syntax for identifying a specific value within a JSON
/// document
...
class json_pointer {
 ...
 public:
  ...
  /// @brief create a new JSON pointer by appending the right JSON pointer at the end of the left
  /// JSON pointer
  ...
  /// @brief create a new JSON pointer by appending the unescaped token at the end of the JSON
  /// pointer
  /// @sa https://json.nlohmann.me/api/json_pointer/operator_slash/
  ...
  */
  ...
  static typename BasicJsonType::size_type array_index(const string_t& s) {
    ...
    {
      JSON_THROW(
          detail::out_of_range::create(410,
      ...
      case detail::value_t::object: {
        if (value.m_data.m_value.object->empty()) {
          ...
          for (const auto& element : *value.m_data.m_value.object) {
            flatten(detail::concat<string_t>(reference_string, '/', detail::escape(element.first)),
                    element.second,
                    result);
          }
        }
  ...
  static BasicJsonType unflatten(const BasicJsonType& value) {
    ...
    for (const auto& element : *value.m_data.m_value.object) {
      if (JSON_HEDLEY_UNLIKELY(!element.second.is_primitive())) {
        JSON_THROW(
            detail::type_error::create(315, "values in object must be primitive", &element.second));
      }
