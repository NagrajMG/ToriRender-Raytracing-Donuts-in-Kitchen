 ...
 private:
  ...
  JSON_PRIVATE_UNLESS_TESTED :
    ...
    void destroy(value_t t) {
      if ((t == value_t::object && object == nullptr) ||
...
#pragma warning(pop)
 ...
 public:
  ...
  basic_json(const value_t v) : m_data(v) {
    assert_invariant();
  }
  ...
  template <typename CompatibleType,
            ...
            detail::enable_if_t<!detail::is_basic_json<U>::value &&
  ...
  basic_json(initializer_list_t init,
    ...
    // element is a string
    bool is_an_object =
        std::all_of(init.begin(), init.end(), [](const detail::json_ref<basic_json>& element_ref) {
          // The cast is to ensure op[size_type] is called, bearing in mind size_type may not be
          // int; (many string types can be constructed from 0 via its null-pointer guise, so we get
          // a broken call to op[key_type], the wrong semantics and a 4804 warning on Windows)
  ...
  */
  ...
  static ReferenceType get_ref_impl(ThisType& obj) {
    ...
    JSON_THROW(type_error::create(
        303,
        detail::concat("incompatible ReferenceType for get_ref, actual type is ", obj.type_name()),
        &obj));
  }
  ...
  */
  template <typename ValueType,
            detail::enable_if_t<detail::has_non_default_from_json<basic_json_t, ValueType>::value,
                                int> = 0>
  ValueType get_impl(detail::priority_tag<1> /*unused*/) const noexcept(
  ...
  */
  template <typename BasicJsonType,
            detail::enable_if_t<std::is_same<BasicJsonType, basic_json_t>::value, int> = 0>
...
#endif
      auto get() const
      noexcept(noexcept(std::declval<const basic_json_t&>().template get_impl<ValueType>(
  ...
  */
  ...
  template <
      class KeyType,
      detail::enable_if_t<detail::is_usable_as_basic_json_key_type<basic_json_t, KeyType>::value,
                          int> = 0>
  ...
  /// @sa https://json.nlohmann.me/api/basic_json/operator%5B%5D/
  reference operator[](
      typename object_t::key_type key)  // NOLINT(performance-unnecessary-value-param)
  {
 ...
 private:
  ...
  template <typename ValueType>
  using value_return_type = std::conditional<detail::is_c_string_uncvref<ValueType>::value,
                                             string_t,
 ...
 public:
  ...
  JSON_HEDLEY_DEPRECATED_FOR(
      ...
      basic_json::json_pointer or
          nlohmann::json_pointer<basic_json::string_t>)  // NOLINT(readability/alt_tokens)
  ReturnType
      value(const ::nlohmann::json_pointer<BasicJsonType>& ptr, ValueType&& default_value) const {
  ...
  IteratorType erase(IteratorType first,
                     IteratorType last)  // NOLINT(performance-unnecessary-value-param)
  {
    // make sure iterator fits the current value
 ...
 public:
  ...
  bool contains(KeyType&& key) const {
    return is_object() &&
           m_data.m_value.object->find(std::forward<KeyType>(key)) != m_data.m_value.object->end();
  }
 ...
 public:
  ...
  std::pair<iterator, bool> emplace(Args&&... args) {
    ...
    if (JSON_HEDLEY_UNLIKELY(!(is_null() || is_object()))) {
      JSON_THROW(
          type_error::create(311, detail::concat("cannot use emplace() with ", type_name()), this));
    }
  ...
  iterator insert_iterator(const_iterator pos,
  ...
  iterator insert(const_iterator pos,
                  const basic_json& val)  // NOLINT(performance-unnecessary-value-param)
  {
  ...
  /// @sa https://json.nlohmann.me/api/basic_json/insert/
  iterator insert(const_iterator pos,
                  basic_json&& val)  // NOLINT(performance-unnecessary-value-param)
  {
  ...
  iterator insert(const_iterator pos,
                  ...
                  const_iterator last)  // NOLINT(performance-unnecessary-value-param)
  {
    // insert only works for arrays
  ...
  /// @sa https://json.nlohmann.me/api/basic_json/insert/
  iterator insert(const_iterator pos,
                  initializer_list_t ilist)  // NOLINT(performance-unnecessary-value-param)
  {
    // insert only works for arrays
    if (JSON_HEDLEY_UNLIKELY(!is_array())) {
      JSON_THROW(
  ...
  void update(const_iterator first,
              const_iterator last,
              bool merge_objects = false)  // NOLINT(performance-unnecessary-value-param)
  {
    // implicitly convert null value to an empty object
    if (is_null()) {
      m_data.m_type = value_t::object;
    ...
    if (JSON_HEDLEY_UNLIKELY(!is_object())) {
      JSON_THROW(
          type_error::create(312, detail::concat("cannot use update() with ", type_name()), this));
    }
...
#define JSON_IMPLEMENT_OPERATOR(op, null_result, unordered_result, default_result)          \
  ...
  {                                                                                         \
    ...
    return static_cast<number_float_t>(lhs.m_data.m_value.number_integer)                   \
        op rhs.m_data.m_value.number_float;                                                 \
  } else if (lhs_type == value_t::number_float && rhs_type == value_t::number_integer) {    \
    return lhs.m_data.m_value.number_float op static_cast<number_float_t>(                  \
        rhs.m_data.m_value.number_integer);                                                 \
  } else if (lhs_type == value_t::number_unsigned && rhs_type == value_t::number_float) {   \
    return static_cast<number_float_t>(lhs.m_data.m_value.number_unsigned)                  \
        op rhs.m_data.m_value.number_float;                                                 \
  } else if (lhs_type == value_t::number_float && rhs_type == value_t::number_unsigned) {   \
    return lhs.m_data.m_value.number_float op static_cast<number_float_t>(                  \
        rhs.m_data.m_value.number_unsigned);                                                \
  } else if (lhs_type == value_t::number_unsigned && rhs_type == value_t::number_integer) { \
    return static_cast<number_integer_t>(lhs.m_data.m_value.number_unsigned)                \
        op rhs.m_data.m_value.number_integer;                                               \
  } else if (lhs_type == value_t::number_integer && rhs_type == value_t::number_unsigned) { \
    return lhs.m_data.m_value.number_integer op static_cast<number_integer_t>(              \
        rhs.m_data.m_value.number_unsigned);                                                \
  ...
  JSON_PRIVATE_UNLESS_TESTED :
      ...
      static bool compares_unordered(const_reference lhs,
                                     const_reference rhs,
...
#pragma GCC diagnostic pop
  ...
  /// @sa https://json.nlohmann.me/api/basic_json/operator_spaceship/
  template <typename ScalarType>
      requires std::is_scalar_v<ScalarType> std::partial_ordering operator<= >
      (ScalarType rhs) const noexcept  // *NOPAD*
  {
...
#undef JSON_IMPLEMENT_OPERATOR
  ...
  JSON_HEDLEY_WARN_UNUSED_RESULT static basic_json parse(InputType&& i,
                                                         ...
                                                         const bool ignore_comments = false) {
    basic_json result;
    parser(detail::input_adapter(std::forward<InputType>(i)),
           std::move(cb),
           allow_exceptions,
           ignore_comments)
        .parse(true, result);  // cppcheck-suppress[accessMoved,accessForwarded]
    return result;
  }
  ...
  JSON_HEDLEY_WARN_UNUSED_RESULT static basic_json parse(IteratorType first,
    ...
    parser(detail::input_adapter(std::move(first), std::move(last)),
           ...
           allow_exceptions,
           ignore_comments)
        .parse(true, result);  // cppcheck-suppress[accessMoved]
    return result;
  }
  ...
  static basic_json parse(detail::span_input_adapter&& i,
                          ...
                          const bool ignore_comments = false) {
    basic_json result;
    parser(i.get(), std::move(cb), allow_exceptions, ignore_comments)
        .parse(true, result);  // cppcheck-suppress[accessMoved]
    return result;
  }
  ...
  static bool accept(InputType&& i, const bool ignore_comments = false) {
    return parser(
               detail::input_adapter(std::forward<InputType>(i)), nullptr, false, ignore_comments)
        .accept(true);
  }
 ...
 public:
  ...
  static std::vector<std::uint8_t> to_bjdata(
      const basic_json& j,
      const bool use_size = false,
      const bool use_type = false,
  ...
  JSON_HEDLEY_WARN_UNUSED_RESULT static basic_json from_cbor(
    ...
    const bool res =
        binary_reader<decltype(ia)>(std::move(ia), input_format_t::cbor)
            .sax_parse(
                input_format_t::cbor, &sdp, strict, tag_handler);  // cppcheck-suppress[accessMoved]
  ...
  template <typename T>
  JSON_HEDLEY_WARN_UNUSED_RESULT JSON_HEDLEY_DEPRECATED_FOR(3.8.0,
                                                            from_cbor(ptr,
  ...
  JSON_HEDLEY_WARN_UNUSED_RESULT static basic_json from_msgpack(
    ...
    detail::json_sax_dom_parser<basic_json, decltype(ia)> sdp(result, allow_exceptions);
    const bool res =
        binary_reader<decltype(ia)>(std::move(ia), input_format_t::msgpack)
            .sax_parse(input_format_t::msgpack, &sdp, strict);  // cppcheck-suppress[accessMoved]
    return res ? result : basic_json(value_t::discarded);
  }
  ...
  JSON_HEDLEY_WARN_UNUSED_RESULT static basic_json from_ubjson(InputType&& i,
    ...
    detail::json_sax_dom_parser<basic_json, decltype(ia)> sdp(result, allow_exceptions);
    const bool res =
        binary_reader<decltype(ia)>(std::move(ia), input_format_t::ubjson)
            .sax_parse(input_format_t::ubjson, &sdp, strict);  // cppcheck-suppress[accessMoved]
    return res ? result : basic_json(value_t::discarded);
  }
  ...
  /// @sa https://json.nlohmann.me/api/basic_json/from_ubjson/
  template <typename IteratorType>
  JSON_HEDLEY_WARN_UNUSED_RESULT static basic_json from_ubjson(IteratorType first,
                                                               IteratorType last,
                                                               const bool strict = true,
                                                               const bool allow_exceptions = true) {
    basic_json result;
  ...
  JSON_HEDLEY_WARN_UNUSED_RESULT static basic_json from_bjdata(InputType&& i,
    ...
    detail::json_sax_dom_parser<basic_json, decltype(ia)> sdp(result, allow_exceptions);
    const bool res =
        binary_reader<decltype(ia)>(std::move(ia), input_format_t::bjdata)
            .sax_parse(input_format_t::bjdata, &sdp, strict);  // cppcheck-suppress[accessMoved]
    return res ? result : basic_json(value_t::discarded);
  }
  ...
  /// @sa https://json.nlohmann.me/api/basic_json/from_bjdata/
  template <typename IteratorType>
  JSON_HEDLEY_WARN_UNUSED_RESULT static basic_json from_bjdata(IteratorType first,
                                                               IteratorType last,
                                                               const bool strict = true,
                                                               const bool allow_exceptions = true) {
    basic_json result;
  ...
  JSON_HEDLEY_WARN_UNUSED_RESULT static basic_json from_bson(InputType&& i,
    ...
    detail::json_sax_dom_parser<basic_json, decltype(ia)> sdp(result, allow_exceptions);
    const bool res =
        binary_reader<decltype(ia)>(std::move(ia), input_format_t::bson)
            .sax_parse(input_format_t::bson, &sdp, strict);  // cppcheck-suppress[accessMoved]
    return res ? result : basic_json(value_t::discarded);
  }
  ...
  /// @sa https://json.nlohmann.me/api/basic_json/from_bson/
  template <typename IteratorType>
  JSON_HEDLEY_WARN_UNUSED_RESULT static basic_json from_bson(IteratorType first,
                                                             IteratorType last,
                                                             const bool strict = true,
                                                             const bool allow_exceptions = true) {
    basic_json result;
  ...
  void patch_inplace(const basic_json& json_patch) {
    ...
    for (const auto& val : json_patch) {
      ...
      const auto get_value =
          [&val](const string_t& op, const string_t& member, bool string_type) -> basic_json& {
        // find value
